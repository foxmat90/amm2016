       <%@include file="head1.jsp" %>
        ...
        <form action="user_form.asp" method="get">
            ...
            <table>
                ...
                <tr>
                    <td> <label for="nome_oggetto">Nome dell'oggetto (o mettere id per elimnare o per modificare)</label> </td>
                    <td>    <input type="text" name="nome_oggetto"
                                   id="nome_oggetto" value="" /></td>

                </tr>
                <tr>
                    <td><label for="url_immagine">Immagine dell'oggetto (o mettere nome del campo da modificare per modificare)</label></td>
                    <td><input type="url" name="url_immagine"
                               id="url_immagine" value="" /></td>

                </tr>
                <tr>
                    <td><label for="descr">Descrizione dell'oggetto (o mettere nuovo valore al campo da modificare per modificare)</label></td>
            ...
            <input class="button" name="act" type="submit" value="Invia" />
            <input class="button" name="act" type="submit" value="Modifica" />
            <input class="button" name="act" type="submit" value="Elimina" />
        </form>
        </div>
